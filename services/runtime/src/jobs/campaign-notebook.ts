...
<body>
  ...
  <nav class="site-nav" aria-label="Site navigation">
    ...
    <a href="/" style="padding-left:24px;color:var(--muted);font-size:.875rem">World Model</a>
    <a href="/questions" style="padding-left:24px;color:var(--muted);font-size:.875rem">Questions</a>
    <a href="/outcomes" style="padding-left:24px;color:var(--muted);font-size:.875rem">Outcomes</a>
